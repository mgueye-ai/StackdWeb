...
<body style="margin:0;padding:0;background-color:#f5f5f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="padding:32px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border:1px solid #e5e5e5;border-radius:16px;">
          <tr>
            <td style="padding:28px 32px;">
              <p style="margin:0 0 8px;font-size:12px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#666666;">
                New order
              </p>
              <h1 style="margin:0 0 20px;font-size:24px;font-weight:700;color:#111111;">
                ${productName} — ${amountFormatted}
              </h1>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;line-height:1.7;color:#333333;">
                <tr>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;"><strong>Customer</strong></td>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;text-align:right;">${customerEmail}</td>
                </tr>
                <tr>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;"><strong>Product</strong></td>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;text-align:right;">${productName} (${productTag})</td>
                </tr>
                <tr>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;"><strong>Amount</strong></td>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;text-align:right;">${amountFormatted}</td>
                </tr>
                <tr>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;"><strong>Session</strong></td>
                  <td style="padding:8px 0;border-top:1px solid #eeeeee;text-align:right;font-size:12px;word-break:break-all;">${sessionId}</td>
                </tr>
              </table>
              <p style="margin:24px 0 0;font-size:13px;color:#666666;">
                View payment details in your <a href="https://dashboard.stripe.com/payments" style="color:#111111;">Stripe dashboard</a>.
              </p>
            </td>
          </tr>
        </table>
...
function adminNotificationText({ productName, amountFormatted, customerEmail, sessionId }) {
  return [
    "New Stackd order received.",
    "",
    `Product: ${productName}`,
